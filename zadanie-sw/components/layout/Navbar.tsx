  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-white z-50 h-42 sm:h-27 h-50.5 ">
      <nav className="px-4 xl:px-0 flex flex-col sm:flex-row items-center sm:py-7.5 gap-4 flex mx-auto max-w-screen-xl sw:w-80 xl:w-300 ">
        {/* Logo */}
        <div className="flex items-center justify-between w-full sm:40 sm:contents order-1 sm:order-none mt-6 ">
        ...
        {/* Filters */}
        <div className="flex flex-col sm:items-center order-3 sm:order-2 sm:flex-row xl:mx-36 sm:pl-28 w-full ">
            ...
            <div className="relative flex-shrink-0 w-full">
              ...
              <input
                ...
                className="border-1 sm:border-2 border-[#E0E2EA] rounded-lg
                        h-12 w-full
                        focus:outline-none focus:border-gray-950  focus:placeholder:text-[#1A1B1D]  pl-4
...
width="24" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                className="absolute sm:right-3 right-1 top-1/2 -translate-y-1/2 h-6 w-6 text-[#1A1B1D] pointer-events-none"
                aria-hidden="true"
              >
